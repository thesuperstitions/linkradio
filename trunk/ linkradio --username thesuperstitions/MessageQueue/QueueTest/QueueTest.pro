...
# Input
HEADERS       += mainwindow.h InterprocessQueue.h Thread.h InterprocessQueue.h ConsumerThread.h ProducerThread.h
win32:HEADERS += "C:\Program Files\boost\boost_1_35_0\boost\thread.hpp"
FORMS += QueueTest.ui
SOURCES += main.cpp mainwindow.cpp InterprocessQueue.cpp Thread.cpp ConsumerThread.cpp ProducerThread.cpp
