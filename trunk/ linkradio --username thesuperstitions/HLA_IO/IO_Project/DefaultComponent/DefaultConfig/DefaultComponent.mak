...
HLA_FederateInterface.obj : HLA_FederateInterface.cpp HLA_FederateInterface.h    IO.h HLA_PostOffice.h FederateInterface.h 
	$(CREATE_OBJ_DIR)
...
FederateInterfaceFactory.obj : FederateInterfaceFactory.cpp FederateInterfaceFactory.h    Federate.h FederateInterface.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"FederateInterfaceFactory.obj" "FederateInterfaceFactory.cpp" 



Framework.obj : Framework.cpp Framework.h    FrameworkFederateAmbassador.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Framework.obj" "Framework.cpp" 



IO.obj : IO.cpp IO.h    FederateInterface.h FederateMessage.h IO_Handler.h Message.h PostOffice.h HLA_PostOffice.h FederateIO_Handler.h RtiAmbassador.h HLA_FederateInterface.h OASIS_FederateInterface.h Buffer.h Framework.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"IO.obj" "IO.cpp" 



Control.obj : Control.cpp Control.h    Serializer.h Framework.h 
	$(CREATE_OBJ_DIR)
