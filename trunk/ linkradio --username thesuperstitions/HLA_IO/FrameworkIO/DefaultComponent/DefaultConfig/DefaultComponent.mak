...
LIBS= \
  librti1516.lib libFedTime1516.lib
...
IO.obj : IO.cpp IO.h    FederateInterface.h FederateMessage.h IO_Handler.h Message.h PostOffice.h HLA_PostOffice.h FederateIO_Handler.h RtiAmbassador.h HLA_FederateInterface.h OASIS_FederateInterface.h Buffer.h Framework.h FrameworkFederateAmbassador.h 
	$(CREATE_OBJ_DIR)
...
Configuration.obj : Configuration.h     
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Configuration.obj" "Configuration.h" 
...
clean:
	...
	if exist Configuration.obj erase Configuration.obj
