...
#include "framework/io/FederateInterface.h"
#include <algorithm>
#include <iomanip>
#include <iostream>
#include <sstream>
...
namespace framework
{
	namespace Control
	{
      ...
      framework::io::FederateInterface* createFederateInterface(int interfaceID, int unitNumber, std::string name, unsigned long maxMessageSize, unsigned long maxMessages, framework::io::FederateInterfaceType federateInterfaceType);
