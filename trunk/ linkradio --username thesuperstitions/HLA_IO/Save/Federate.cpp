...
namespace Framework {
    namespace Federate {
        ...
        Framework::IO::FederateInterfaceFactory* Federate::getItsFederateInterfaceFactory() const {
            return itsFederateInterfaceFactory;
        }
        
        void Federate::__setItsFederateInterfaceFactory(Framework::IO::FederateInterfaceFactory* p_FederateInterfaceFactory) {
            itsFederateInterfaceFactory = p_FederateInterfaceFactory;
        }
        
        void Federate::_setItsFederateInterfaceFactory(Framework::IO::FederateInterfaceFactory* p_FederateInterfaceFactory) {
        ...
        void Federate::setItsFederateInterfaceFactory(Framework::IO::FederateInterfaceFactory* p_FederateInterfaceFactory) {
