...
namespace Framework {
    ...
    namespace IO {
        ...
        template <class T> inline void callOutputFunc(T data) {
            //#[ operation callOutputFunc(T) 
            //#]
        }
        ...
        template <class T> inline void callOutputFunc(T data, int timeout) {
            //#[ operation callOutputFunc(T,int) 
            //#]
        }
        ...
        //## operation getFrameworkFederateAmbassador() 
        Framework::Control::FrameworkFederateAmbassador getFrameworkFederateAmbassador();
