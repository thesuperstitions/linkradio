...
namespace Framework {
    namespace IO {
        ...
        Framework::IO::FederateInterfaceFactory* OASIS_FederateInterface::getItsFederateInterfaceFactory() const {
            return itsFederateInterfaceFactory;
        }
        
        void OASIS_FederateInterface::setItsFederateInterfaceFactory(Framework::IO::FederateInterfaceFactory* p_FederateInterfaceFactory) {
